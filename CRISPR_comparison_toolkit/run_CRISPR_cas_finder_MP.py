...
parser = argparse.ArgumentParser(
	description="Given a directory containing fasta genomes, runs CRISPR_cas_finder on all the genomes and stores the outputs in your current working directory.",
